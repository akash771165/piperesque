...
export class ArticleSchemaGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `article-schema:${article.slug ?? article.title}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `Article schema cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `Article schema generated: ${article.slug ?? article.title}`
