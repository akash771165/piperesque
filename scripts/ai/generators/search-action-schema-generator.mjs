...
export class SearchActionSchemaGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `search-action-schema:${website.slug ?? website.domain ?? website.name}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `SearchAction schema cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `SearchAction schema generated: ${website.slug ?? website.name}`
...
export async function generateSearchActionSchema(

  website,

  promptName = "search-action-schema",
  ...
  const generator =
    ...
    new SearchActionSchemaGenerator(
