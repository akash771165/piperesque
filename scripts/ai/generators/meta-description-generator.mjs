...
export class MetaDescriptionGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `meta-description:${content.slug ?? content.title}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `Meta description cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `Meta description generated: ${content.slug ?? content.title}`
