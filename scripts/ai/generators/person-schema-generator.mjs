...
export class PersonSchemaGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `person-schema:${person.slug ?? person.name}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `Person schema cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `Person schema generated: ${person.slug ?? person.name}`
