...
export class CallToActionGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `cta:${content.slug ?? content.title}`;
    ...
    logger.success(
      ...
      `CTA generated: ${content.slug ?? content.title}`
