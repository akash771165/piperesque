...
export class SearchIntentGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `search-intent:${keyword.term ?? keyword.keyword}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `Search intent cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `Search intent generated: ${keyword.term ?? keyword.keyword}`
