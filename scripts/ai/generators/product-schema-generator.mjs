...
export class ProductSchemaGenerator {
  ...
  async generate(
    ...
    const cacheKey =
      ...
      `product-schema:${product.slug ?? product.name}`;
    ...
    if (
      ...
      if (
        ...
        logger.info(
          ...
          `Product schema cache hit: ${cacheKey}`
    ...
    logger.success(
      ...
      `Product schema generated: ${product.slug ?? product.name}`
